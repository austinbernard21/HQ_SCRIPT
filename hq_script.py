...
#def grab_image():
    #image = PIL.Image.open('Screenshot.jpg').convert("L")
    #question_interface = numpy.array(image)
    #question_interface = numpy.array(PIL.ImageGrab.grab(bbox=(23,222,402,581))) #25,185,420,570
    ...
    #image = PIL.Image.fromarray(question_interface,'RGB')
